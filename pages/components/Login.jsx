  ...
  const SignUp = () => {
    return <>
      ...
      <div className="input-wrapper">
        ...
        <input id="0" ref={inputsRef[0]} onChange={(e) => setName(e.target.value)} value={name} type="text" onFocus={e => setFocus(e)} onBlur={e => setAbort(e)} autoComplete="off" required />
        <label className="label" ref={labelsRef[1]}>Phone Number</label>
        <input id="1" ref={inputsRef[1]} onChange={(e) => setPhone(e.target.value)} value={phone} type="text" onFocus={e => setFocus(e)} onBlur={e => setAbort(e)} autoComplete="off" required />
        <label className="label" ref={labelsRef[2]}>Email Address</label>
        <input id="2" ref={inputsRef[2]} onChange={(e) => setEmail(e.target.value)} value={email} type="text" onFocus={e => setFocus(e)} onBlur={e => setAbort(e)} autoComplete="off" required />
        <label className="label" ref={labelsRef[3]}>Password</label>
        <input id="3" ref={inputsRef[3]} onChange={(e) => setPassword(e.target.value)} value={password} type="text" onFocus={e => setFocus(e)} onBlur={e => setAbort(e)} autoComplete="off" required />
      </div>
  ...
  const SignIn = () => {
    return <>
      ...
      <div className="input-wrapper">
        ...
        <input id="0" ref={inputsRef[0]} type="text" onChange={(e) => setEmail(e.target.value)} value={email} onFocus={e => setFocus(e)} onBlur={e => setAbort(e)} autoComplete="off" required />
        <label className="label" ref={labelsRef[1]}>Password</label>
        <input id="1" ref={inputsRef[1]} type="text" onChange={(e) => setPassword(e.target.value)} value={password} onFocus={e => setFocus(e)} onBlur={e => setAbort(e)} autoComplete="off" required />
      </div>
